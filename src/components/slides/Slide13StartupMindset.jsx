...
const mindsets = [
  ...
  {
    icon: '🏗️',
    title: 'Start Building Early',
    body: "Your first project will be terrible. Build it anyway. That's how you grow.",
    color: '#f472b6',
    delay: 0.5,
  },
]

export default function Slide13StartupMindset({ direction }) {
  return (
