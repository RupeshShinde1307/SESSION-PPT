...
export default function Slide10FindProblem({ direction }) {
  return (
    <SlideWrapper direction={direction}>
      <div className="relative z-10 w-full max-w-5xl px-8 flex flex-col gap-8">
        ...
        >
          ...
          >
            Startups begin with problems. Look around — they're everywhere.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-4 gap-4">
          {problems.map((p, i) => (
            ...
            >
              ...
              <div className="text-xs font-semibold mt-auto" style={{ color: p.color }}>
                Real problem ↗
              </div>
            </motion.div>
          ))}
