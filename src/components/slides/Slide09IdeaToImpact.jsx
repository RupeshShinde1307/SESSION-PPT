...
export default function Slide09IdeaToImpact({ direction }) {
  return (
        ...
        <div className="flex items-center gap-0 w-full justify-center">
          {steps.map((step, i) => (
            <div key={i} className="flex items-center">
              ...
              >
                <div
                  className="w-[90px] h-[90px] rounded-2xl flex items-center justify-center text-3xl relative"
                  style={{
              ...
              {i < steps.length - 1 && (
                ...
                >
                  <div
                    className="w-8 h-[2px]"
                    style={{ background: `linear-gradient(90deg, ${steps[i].color}60, ${steps[i + 1].color}60)` }}
                  />
                  <div style={{
                    width: 0, height: 0,
